    ...
    for epoch in range(100):
        ...
        for inputs, labels in train_loader:
            ...
            features = [
                ...
                inputs["rsi"].unsqueeze(-1),
                inputs["macd"].unsqueeze(-1),
                inputs["macdignal"].unsqueeze(-1),
                inputs["macdhist"].unsqueeze(-1),
                inputs["sma"].unsqueeze(-1),
                inputs["ema"].unsqueeze(-1),
                inputs["upperband"].unsqueeze(-1),
                inputs["lowerband"].unsqueeze(-1),
                inputs["middleband"].unsqueeze(-1)
            ]
